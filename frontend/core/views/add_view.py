...
class AddPageView(View):
    ...
    def _create_header(self):
        self.header = Header(
            master=self, fg_color=AddStyles.HEADER_SECTION_FG_COLOR, corner_radius=0
        )
...
class TransactionForm(ctk.CTkFrame):
    ...
    def _create_sections(self):
        self.top_section = ctk.CTkFrame(
            master=self, fg_color=AddStyles.FORM_TOP_SECTION_FG_COLOR, corner_radius=0
        )
        self.top_section.pack(fill="both", pady=(BaseStyles.PAD_4, 0))

        self.mid_section = ctk.CTkFrame(
            master=self, fg_color=AddStyles.FORM_MID_SECTION_FG_COLOR, corner_radius=0
        )
        self.mid_section.pack(fill="both", pady=(BaseStyles.PAD_4, 0))

        self.bot_section = ctk.CTkFrame(
            master=self, fg_color=AddStyles.FORM_BOT_SECTION_FG_COLOR, corner_radius=0
        )
