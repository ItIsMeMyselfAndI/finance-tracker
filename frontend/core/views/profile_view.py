...
class ProfilePageView(View):
    def __init__(self, model: ProfilePageModel, master, **kwargs):
    ...
    def _create_summaries(self):
        ...
        self.income_frame.grid(
            row=0,
            column=0,
            padx=(BaseStyles.PAD_4, 0),
            pady=(BaseStyles.PAD_4, 0),
            sticky="nsew",
        )
        ...
        self.investment_frame.grid(
            row=1, column=1, pady=BaseStyles.PAD_4, padx=BaseStyles.PAD_4, sticky="nsew"
        )
        self.update_idletasks()
...
class SummarySection(ctk.CTkFrame):
    ...
    def create(
        self, img: ctk.CTkImage, img_bg_color: str, summary_type: str, amount: float
    ):
    ...
    def _create_icon(self, img: ctk.CTkImage, img_bg_color: str):
        ...
        self.img_bg.grid(
            row=0, column=0, padx=(BaseStyles.PAD_5, 0), pady=BaseStyles.PAD_5
        )
        self.update_idletasks()
        print("[DEBUG] icon created successfully")
    ...
    def _create_summary(self, summary_type: str, amount: float):
        ...
        self.summary_frame.grid(
            row=0,
            column=1,
            padx=(BaseStyles.PAD_3, BaseStyles.PAD_5),
            pady=BaseStyles.PAD_1,
        )
