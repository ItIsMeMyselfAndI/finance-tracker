...
class LoginPageView(View):
    ...
    def _load_icon(self):
        if hasattr(sys, "_MEIPASS"):  # # for .exe: memory resources path
            ...
            ICONS_FOLDER: str = os.path.join(_MEIPASS, "frontend\\assets\\icons")
    ...
    def _create_form_frame(self):
        ...
        self.form = ctk.CTkFrame(
            master=self, fg_color=self.form_fg_color, corner_radius=BaseStyles.RAD_5
        )
    ...
    def _create_btns(self):
        ...
        self.signup_button.pack(
            padx=BaseStyles.PAD_4 * 2, pady=(0, BaseStyles.PAD_4 * 2)
        )
