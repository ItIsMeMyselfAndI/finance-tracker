...
from frontend.widgets.table import (
...
class HistoryPageView(View):
    ...
    def _create_table(self):
        ...
        transactions_per_filter: Dict[str, List[Transaction]] = (
...
class Header(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.title_label.grid(
            row=0, column=0, padx=BaseStyles.PAD_4, pady=BaseStyles.PAD_1
        )
...
class TransactionTable(ctk.CTkFrame):
    ...
    def _create_nav(self):
        ...
        self.nav = TransactionTableNavigation(
            table_body=self.body, master=self, fg_color=HistoryStyles.TABLE_NAV_FG_COLOR
        )
    ...
    def _create_filters(self, filter_master):
        ...
        self.filters.grid(
            row=0,
            column=1,
            padx=(0, BaseStyles.PAD_2),
            pady=(0, BaseStyles.PAD_2),
            sticky="s",
        )
        self.update_idletasks()
